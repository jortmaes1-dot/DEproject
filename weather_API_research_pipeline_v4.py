...
#    - Regenachtig
#    - Droog
#    Daarnaast blijven strict_weather_type en weer-scores beschikbaar,
#    maar de finale analyses gebruiken geen neutrale middencategorie.
...
def add_weather_types(df):
    ...
    # Hoofdbenchmark zonder neutrale categorie:
    # Regenachtig = alle dagen met neerslag
    # Droog = dagen zonder gemeten neerslag
